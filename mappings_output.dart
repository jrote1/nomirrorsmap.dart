...
class TestProjectMappings
{
	...
	{
		NoMirrorsMapStore.registerClass( "InheritedClass", web_main_dart.InheritedClass, () => new web_main_dart.InheritedClass(), const {
			'data': List
		} );
		NoMirrorsMapStore.registerClass( "TypeWithNoProperties", web_main_dart.TypeWithNoProperties, () => new web_main_dart.TypeWithNoProperties(), const {
		} );
		NoMirrorsMapStore.registerClass( "SimpleTypeUsingDollarRef", web_main_dart.SimpleTypeUsingDollarRef, () => new web_main_dart.SimpleTypeUsingDollarRef(), const {
			'name': String,
			'people': List
		} );
		NoMirrorsMapStore.registerClass( "NewtonSoftTest", web_main_dart.NewtonSoftTest, () => new web_main_dart.NewtonSoftTest(), const {
			'age': int,
			'gender': String
		} );
		NoMirrorsMapStore.registerClass( "Person", web_main_dart.Person, () => new web_main_dart.Person(), const {
			'id': int,
			'parents': List,
			'children': List
		} );
		NoMirrorsMapStore.registerClass( "ClassWithDouble", web_main_dart.ClassWithDouble, () => new web_main_dart.ClassWithDouble(), const {
			'val': double
		} );
		NoMirrorsMapStore.registerClass( "CustomConverterParentTest", web_main_dart.CustomConverterParentTest, () => new web_main_dart.CustomConverterParentTest(), const {
			'testProperty': web_main_dart.CustomConverterTest
		} );
		NoMirrorsMapStore.registerClass( "CustomConverterTest", web_main_dart.CustomConverterTest, () => new web_main_dart.CustomConverterTest(), const {
			'id': int,
			'value': String
		} );
		NoMirrorsMapStore.registerClass( "TestObjectWithCustomList", web_main_dart.TestObjectWithCustomList, () => new web_main_dart.TestObjectWithCustomList(), const {
			'customList': web_main_dart.CustomList
		} );
		NoMirrorsMapStore.registerClass( "NoTypeTestClass", web_main_dart.NoTypeTestClass, () => new web_main_dart.NoTypeTestClass(), const {
			'id': int,
			'firstName': String,
			'testProperty': web_main_dart.NoTypeTestPropertyClass
		} );
		NoMirrorsMapStore.registerClass( "NoTypeTestPropertyClass", web_main_dart.NoTypeTestPropertyClass, () => new web_main_dart.NoTypeTestPropertyClass(), const {
			'id': int,
			'name': String
		} );
		...
		NoMirrorsMapStore.registerClass( "TeamMember", web_main_dart.TeamMember, () => new web_main_dart.TeamMember(), const {
			'role': web_main_dart.Role,
			'user': web_main_dart.User
		} );
		NoMirrorsMapStore.registerClass( "Role", web_main_dart.Role, () => new web_main_dart.Role(), const {
			'id': int,
			'name': String
		} );
		NoMirrorsMapStore.registerClass( "SecurityRole", web_main_dart.SecurityRole, () => new web_main_dart.SecurityRole(), const {
			'id': int,
			'name': String,
			'description': String,
			'associationLevel': web_main_dart.AssociationLevel
		} );
		NoMirrorsMapStore.registerClass( "AssociationLevel", web_main_dart.AssociationLevel, () => new web_main_dart.AssociationLevel(), const {
			'id': int,
			'value': String
		} );
		NoMirrorsMapStore.registerClass( "ClassWithDateTime", web_main_dart.ClassWithDateTime, () => new web_main_dart.ClassWithDateTime(), const {
			'time': DateTime
		} );
	}
