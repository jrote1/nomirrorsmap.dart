...
class _GeneratorParameters {
  ...
  _GeneratorParameters(this.mappingsClassName, this.assetId, List<Element> typesToMap, Map<LibraryElement, String> libraryImportAliases)
      : this.typesToMap = new UnmodifiableListView<Element>(typesToMap),
        this.libraryImportAliases = new UnmodifiableMapView<LibraryElement, String>(libraryImportAliases);
}
