...
class _TypeInformationRetriever {
  ...
  String _getActualTypeText(InterfaceType type, _GeneratorParameters parameters) {
    ...
    if (parameters.libraryImportAliases.containsKey(type.element.library)) typeName =
  ...
  bool _typeHasConstructor(ClassElement type) {
    return type.constructors.any((constructor) => constructor.parameters.length == 0) && !type.isAbstract;
  }
}
