...
main() async {
    ...
    group("${noMirrorsMapFuncKey} tests", () {
      ...
      group("Serialization Tests", () {
        test("Can serialize an object that is null", () {
          var result = noMirrorsMap.convert(null, new ClassConverter(), new JsonConverter());
          expect(result, "null");
        });
        ...
        test("Performance test", () {
          ...
          noMirrorsMap.convert(list, new ClassConverter(), new NewtonSoftJsonConverter());
          stopwatch.stop();
        ...
        test("Generic test", () {
          ...
          var json = noMirrorsMap.convert(person, new ClassConverter(), new NewtonSoftJsonConverter());
          noMirrorsMap.convert(json, new NewtonSoftJsonConverter(), new ClassConverter(startType: PersonGeneric));
        });
        ...
        test("Can deserialize to object", () {
          ...
          var result = noMirrorsMap.convert(json, new JsonConverter(), new ClassConverter(startType: TypeWithDuration))
              as TypeWithDuration;
      ...
      group("Deserialization Tests", () {
        test("Can deserialize null DateTime", () {
          ...
          var result =
              noMirrorsMap.convert(json, new JsonConverter(), new ClassConverter(startType: DateTime)) as Person;
  ...
  "children": []
          ...
          var result = noMirrorsMap.convert(json, new JsonConverter(), new ClassConverter()) as Person;
  ...
  "children": []
        ...
        test("Can deserialize objects that do not have \$type", () {
          ...
          Person result = noMirrorsMap.convert(json, new JsonConverter(), new ClassConverter(startType: Person));
        ...
        test("Can deserialize null", () {
          var result = noMirrorsMap.convert("null", new JsonConverter(), new ClassConverter());
          expect(result, null);
        });
        ...
        test("Can deserialize using CamelCaseManipulator", () {
          ...
          Person result =
              noMirrorsMap.convert(json, new JsonConverter(), new ClassConverter(), [new CamelCaseManipulator()]);
          expect(result.id, 1);
        });
    ...
    "AssociationLevel": {
      ...
      "Value": "Top"
        ...
        test("Can deserialize type that contains a DateTime", () {
          ClassWithDateTime result = noMirrorsMap.convert("{\"time\": \"2055-02-03T15:57:12\"}", new JsonConverter(),
  ...
  "testProperty": {
    ...
    "name": "OtherName"
          ...
          NoTypeTestClass result =
              noMirrorsMap.convert(json, new JsonConverter(), new ClassConverter(startType: NoTypeTestClass));
      ...
      group("JsonConverter tests", () {
        ...
        test("can convert int in json to enum value", () {
          var result = noMirrorsMap.convert("0", new JsonConverter(), new ClassConverter(startType: TestEnum));
      ...
      "$ref": "1"
        ...
        test("can serialize object with no properties", () {
          ...
          noMirrorsMap.convert(json, new NewtonSoftJsonConverter(),
              new ClassConverter(startType: const TypeOf<List<TypeWithNoProperties>>().type));
        });
      ...
      "$ref": "1"
        ...
        test("Can deserialize generic", () {
          ...
          var result = noMirrorsMap.convert(
                  json, new JsonConverter(), new ClassConverter(startType: const TypeOf<GenericType>().type))
              as GenericType<int>;
          expect(result.id, 1);
        });
      });
